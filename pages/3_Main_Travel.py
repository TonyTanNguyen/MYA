...
try:
    ...
    if "Partner Name" not in df_main.columns:
        ...
        # Filters for Country and Location
        ...
        search_keyword = st.text_input(
            "Enter partner name or keyword to search:",
            placeholder="e.g., Hotel ABC, Tour Company XYZ...",
            key="partner_search"
        )
        
        if search_keyword or selected_country != "All Countries" or selected_location != "All Locations":
            # Apply filters
            ...
            if not df_filtered.empty:
                ...
                for idx, row in df_filtered.iterrows():
                    ...
                    with st.container():
                        with st.expander(f"📋 {partner_name}", expanded=False):
                            # Display key information in 3x2 grid
                            ...
                            # Show full partner data in expandable section
                            with st.expander("📊 Full Partner Data", expanded=False):
                                ...
                                try:
                                    ...
                                    if not partner_feedback.empty:
                                        ...
                                        for feedback_idx, feedback_row in partner_feedback.iterrows():
                                            ...
                                            with st.container():
                                                with st.expander(f"📋 {feedback_type}", expanded=False):
